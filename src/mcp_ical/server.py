...
async def create_event(create_event_request: CreateEventRequest) -> str:
    ...
    6. If the user mentions a different timezone (e.g., "7pm Paris time"), ask if they want the event
    ...
    Args:
        ...
        recurrence_rule: Optional recurrence rule for the event. This should be an instance of `RecurrenceRule` with the following fields:
            ...
            - days_of_week: Optional list of weekdays for the event. Use integers to represent days:
                ...
                - Friday: 6
                - Saturday: 7
        timezone: Optional IANA timezone identifier for the event (e.g., "Europe/Paris", "America/New_York",
            "Asia/Tokyo"). When set, the event will be stored in that timezone. This is useful when traveling
            or scheduling events in a different timezone than your current location.
            Example: If you're in NYC but want to create "dinner at 7pm Paris time", set timezone="Europe/Paris"
            and start_time to 19:00. The event will display as 7pm when viewed in Paris timezone.
            ...
            - Other: "UTC", "Pacific/Auckland", "America/Sao_Paulo"
        ...
        update_event_request: Object containing the fields to update:
            ...
            - recurrence_rule: Optional recurrence rule for the event. This should be an instance of `RecurrenceRule` with the following fields:
                ...
                - days_of_week: Optional list of weekdays for the event. Use integers to represent days:
                    ...
                    - Friday: 6
                    - Saturday: 7
            - timezone: Optional IANA timezone identifier (e.g., "Europe/Paris", "America/New_York").
                Changes the timezone the event is stored in.
